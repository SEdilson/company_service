...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('company_service', '0037_auto_20190930_1310'),
    ]

    operations = [
        migrations.CreateModel(
            name='ReworkNotification',
            fields=[
                ...
                ('rework_code', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='company_service.ReworkCode')),
            ],
            options={
                'abstract': False,
            },
